...
Copyright = '(c) 2019 rwood. All rights reserved.'
...
FunctionsToExport = @('Invoke-GceCommandAs', 'Install-GceWindowsSsh', 'New-GcePSSession', 'Remove-GcePSSession')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/mkellerman/GcePSSession/blob/main/LICENSE.md'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/mkellerman/GcePSSession'
