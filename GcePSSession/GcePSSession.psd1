...
FunctionsToExport = @('Install-GceWindowsSsh', 'New-GcePSSession', 'Remove-GcePSSession')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = @'
Initial release of GcePSSession module.

Features:
- Create PowerShell remoting sessions to GCE Windows VMs via IAP tunnels
- Execute PowerShell commands remotely using Invoke-GceCommandAs
